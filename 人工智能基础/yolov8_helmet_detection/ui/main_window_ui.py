...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1073, 691)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.input = QLabel(self.centralwidget)
        self.input.setObjectName(u"input")
        self.input.setGeometry(QRect(10, 140, 640, 480))
        ...
        self.buttton_image_select.setGeometry(QRect(720, 220, 70, 31))
        font = QFont()
        ...
        self.buttton_video_select.setGeometry(QRect(720, 340, 70, 31))
        ...
        self.button_weight_select.setGeometry(QRect(100, 90, 130, 21))
        ...
        self.button_weight_init.setGeometry(QRect(330, 90, 130, 21))
        ...
        self.button_image_detect.setGeometry(QRect(860, 220, 70, 31))
        ...
        self.button_image_show.setGeometry(QRect(1000, 220, 70, 31))
        ...
        self.button_video_detect.setGeometry(QRect(860, 340, 70, 31))
        ...
        self.button_video_suspend.setGeometry(QRect(1000, 340, 70, 31))
        ...
        self.button_video_stop.setGeometry(QRect(970, 390, 100, 31))
        ...
        self.button_image_stop.setGeometry(QRect(970, 270, 100, 31))
        ...
        self.button_image_export.setGeometry(QRect(740, 270, 140, 31))
        ...
        self.button_video_export.setGeometry(QRect(740, 390, 140, 31))
        ...
        self.label_weight_select.setGeometry(QRect(40, 92, 34, 21))
...
"}")
        ...
        self.con_slider.setGeometry(QRect(810, 95, 81, 30))
...
"}")
        ...
        self.con_number.setGeometry(QRect(750, 100, 60, 21))
        ...
        self.confidence_2.setGeometry(QRect(900, 100, 41, 21))
...
"}")
        ...
        self.iou_number.setGeometry(QRect(940, 100, 51, 21))
        ...
        self.iou_slider.setGeometry(QRect(990, 95, 81, 30))
...
"}")
        ...
        self.lineEdit_detect_time.setGeometry(QRect(810, 150, 50, 21))
        ...
        self.lineEdit_detect_object_nums.setGeometry(QRect(1000, 150, 50, 21))
        self.lineEdit_detect_object_nums.setReadOnly(True)
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(720, 145, 80, 31))
        self.label_2.setFont(font)
        self.label_2.setAlignment(Qt.AlignCenter)
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(919, 145, 71, 31))
        self.label_3.setFont(font)
        self.label_3.setAlignment(Qt.AlignCenter)
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(760, 530, 80, 31))
        self.label_4.setFont(font)
        self.label_4.setAlignment(Qt.AlignCenter)
        self.comboBox = QComboBox(self.centralwidget)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(950, 530, 120, 31))
        self.label_5 = QLabel(self.centralwidget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(690, 580, 51, 21))
        self.label_5.setFont(font1)
        self.label_5.setAlignment(Qt.AlignCenter)
        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(690, 610, 51, 21))
        self.label_6.setFont(font1)
        self.label_6.setAlignment(Qt.AlignCenter)
        self.lineEdit_xmin = QLineEdit(self.centralwidget)
        self.lineEdit_xmin.setObjectName(u"lineEdit_xmin")
        self.lineEdit_xmin.setGeometry(QRect(760, 580, 80, 21))
        ...
        self.lineEdit_xmax.setGeometry(QRect(760, 610, 80, 21))
        ...
        self.button_camera_start.setGeometry(QRect(700, 460, 90, 31))
        ...
        self.button_camera_detect.setGeometry(QRect(840, 460, 90, 31))
        ...
        self.button_camera_stop.setGeometry(QRect(980, 460, 90, 31))
        self.button_camera_stop.setFont(font)
        self.label_main = QLabel(self.centralwidget)
        self.label_main.setObjectName(u"label_main")
        self.label_main.setGeometry(QRect(0, -100, 1071, 771))
        self.lineEdit_4 = QLineEdit(self.centralwidget)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(660, 440, 420, 2))
        ...
        self.line.setGeometry(QRect(650, 90, 20, 551))
        font4 = QFont()
        ...
        self.lineEdit_6.setGeometry(QRect(660, 320, 420, 2))
        ...
        self.lineEdit_7.setGeometry(QRect(660, 510, 420, 2))
        ...
        self.lineEdit.setGeometry(QRect(5, 640, 650, 31))
        self.lineEdit.setReadOnly(True)
        self.lineEdit_8 = QLineEdit(self.centralwidget)
        self.lineEdit_8.setObjectName(u"lineEdit_8")
        self.lineEdit_8.setGeometry(QRect(660, 640, 420, 2))
        ...
        self.lineEdit_9.setGeometry(QRect(660, 90, 420, 2))
        self.lineEdit_9.setCursor(QCursor(Qt.IBeamCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input.setText(QCoreApplication.translate("MainWindow", u"\u7a97\u53e3\u533a\u57df", None))
        ...
        self.button_image_detect.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b", None))
        self.button_image_show.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u679c\u5c55\u793a", None))
        self.button_video_detect.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b", None))
        self.button_video_suspend.setText(QCoreApplication.translate("MainWindow", u"\u6682\u505c", None))
        self.button_video_stop.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u675f", None))
        self.button_image_stop.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u675f", None))
        self.button_image_export.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u679c\u5bfc\u51fa", None))
        self.button_video_export.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u679c\u5bfc\u51fa", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"\u57fa\u4e8eYOLOV8\u548cPyside6\u7684\u5b89\u5168\u5e3d\u68c0\u6d4b\u7cfb\u7edf", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:10pt;\">\u5c0f\u7ec4\u6210\u5458\uff1a2151406\u5218\u5353\u660e      2150461\u674e\u65fb\u5112       2053113\u502a\u745e\u9e4f     2150255 \u91d1\u660a</span></p></body></html>", None))
        self.button_camera_start.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5f00\u6444\u50cf\u5934", None))
        self.button_camera_detect.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b", None))
        self.button_camera_stop.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u675f", None))
